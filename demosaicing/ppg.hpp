...
void interpolate_G4RB(rgb_t* p, bool is_red_center) {
  if (is_red_center) {
...
void interpolate_RB4G(rgb_t* p, bool is_even_row) {
  if (is_even_row) {
    ...
    p[4].red = hue_transit(
      ...
      p[4].red = hue_transit(
          p[3].green, p[4].green, p[5].green, p[3].red, p[5].red);
      p[4].blue = hue_transit(
          p[1].green, p[4].green, p[7].green, p[1].blue, p[7].blue);
    }
}

void interpolate_B4R_and_R4B(rgb_t* p, bool is_red_center) {
  if (is_red_center) {
